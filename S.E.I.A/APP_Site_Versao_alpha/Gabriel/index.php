...
$sql = ("SELECT motnome,acigravidade,locx,locy,bainome,ocostatus  FROM ocorrencia inner join seia on ocoseicod=seicod inner join motorista on seimotcod=motcod  inner join ambulancia on ocoambcod=ambcod inner join acidente on ocoacicod=acicod inner join locall on ocoloccod=loccod inner join bairro on baicod=locbaicod where ococod=1 ");
...
<body>
	...
	<div id="login" class="bradius">
		...
		<br/>
                 <label for="locx">Latitude:                                            Longetude:</label><label><?php echo $linha['locx']; php?></label>
